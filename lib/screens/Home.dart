                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Switch(
                        ...
                        onChanged: (val) =>
                            Provider.of<MyProvider>(context, listen: false).switchChange(val),
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) =>
                            GestureDetector(
                          onTap: () {
                            Movie movies = snapshot.data!.mainData[index + 80];
                            Navigator.push(
                                context,
                                PageTransition(
                              ...
                              children: [
                                SizedBox(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.network(
                                      Data.mainData.elementAt(index + 80).image,
                                      fit: BoxFit.cover,
                                      height: 200,
                                    ),
                                  ),
                                ...
                                Column(
                                  children: [
                                    Text(
                                      Data.mainData.elementAt(index + 80).title,
                                      maxLines: 2,
                     ...
                     Row(
                       ...
                       children: [
                         ...
                         TextButton(onPressed: (){
                           Navigator.push(
                             context,
                             PageTransition(type: PageTransitionType.fade, child: Products()),
                           );
                         }, child: Padding(
                           padding: const EdgeInsets.only(left: 60.0),
                           child: Text('See All', style: TextStyle(color: Colors.blue, fontSize: 20),),
                         ))
                       ],
                     ),
                    Expanded(
